...
var databaseUrl = 'mongodb://localhost/rva';
...
app.use(logger("dev"));
// express.static is used to serve the public folder as a static directory.
app.use(express.static("public"));
// body(body-parser) is used for handling form submissions.
